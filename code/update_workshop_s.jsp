...
<html>
    <head>
        ...
        <title>Update Workshops(Samarthya)</title>
    ...
    <body>
        <style>
           body{
                background-size: 100%;
                background-image:  url(https://images.unsplash.com/photo-1541778956252-6c31bbd0ff64?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1789&q=80);    
            }
            .circular--square {
                border-radius: 50%;
            }
        ...
        <div class="container">
            <form  method="post" action="FileUpdateWorkshop"  class="form-horizontal" enctype="multipart/form-data" role="form">
                <h2><font size="6" color="#7d5a69">Samarthya Admin Panel</font></h2>
                <h2>Update Workshops</h2>
                <div class="form-group">
                    <label for="workby" class="col-sm-3 control-label">Workshop name to update</label>
                    <div class="col-sm-9">
